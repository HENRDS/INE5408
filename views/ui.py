...
class WinAddPolygon(WindowEventHandler):
    def __init__(self, app_handler: "UI", builder: Gtk.Builder):
        ...
        # tree_polygon_points handlers
        self.tree_polygon_points.connect("row-activated", self.on_tree_polygon_points_row_activated)
    ...
    def on_tree_polygon_points_row_activated(self, sender: Gtk.TreeView, path: Gtk.TreePath, column: Gtk.TreeViewColumn) -> None:
        """Handler for event 'row-activated' of control tree_polygon_points."""
        pass
